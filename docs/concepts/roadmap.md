...
| 7 — File-workspace substrate | `in-progress` | Planning recorded 2026-07-02: [PLAN.md](../decisions/2026-07-02-phase7-file-workspace-substrate/PLAN.md). Two host-mediated capabilities, **default-deny + workspace-jailed**: **`host-fs`** (path-jailed workspace read/write) and **`host-process`** (bounded run-to-completion exec; long-lived children later). Slices: 7a host-fs, 7b host-process, 7c exit gate. |
