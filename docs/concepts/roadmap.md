...
| 6 — Streaming & steering | `in-progress` | Planning recorded 2026-07-02: [PLAN.md](../decisions/2026-07-02-phase6-streaming-steering/PLAN.md). Slices: 6a conductor event stream (push-based `EventSink`, fits the sync loop), 6b SSE on the REST surface, 6c cancel + steering/follow-up queue, 6d exit gate. Promotes the Phase 2 carry-forward. |
