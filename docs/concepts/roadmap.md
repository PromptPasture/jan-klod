...
| Routes through | `tool-*` |
|---|---|
| `host-fs` | read *(built)*, write *(built)*, grep *(built)*, **edit** *(built)*, **find/glob** *(built)*, ast-edit, ast-grep, checkpoint, git |
