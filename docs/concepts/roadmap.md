...
| Routes through | `tool-*` |
|---|---|
| `host-fs` | read *(built)*, write *(built)*, grep *(built)*, **edit** *(built)*, ast-edit, find (glob), ast-grep, checkpoint, git |
