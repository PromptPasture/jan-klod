...
- [2026-06-28 — MVP WASM Host](2026-06-28-mvp-wasm-host/Handoff.md) — core-module JSON ABI (wazero has no component model), no-CGo confirmed, SQLite runs host-side not in-guest
